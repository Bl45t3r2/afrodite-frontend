    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="font-display text-lg font-bold truncate" style={{color: "var(--text-primary)"}}>{user?.profile?.displayName || "Mon espace"}</h1>
        ...
        <div className="space-y-6">
          ...
          <div className="card p-6">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="font-semibold" style={{color:"var(--text-primary)"}} className2="">Vues — 7 derniers jours</h3>
            </div>
            {stats?.viewsPerDay ? (
      ...
      {tab === 'subscription' && (
        <div className="space-y-6">
          ...
          {payments.length > 0 && (
            <div className="card p-6">
              <h3 className="font-semibold" style={{color:"var(--text-primary)"}} className2=" mb-4">Historique des paiements</h3>
